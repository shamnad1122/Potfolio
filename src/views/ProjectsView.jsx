import { getProjects } from '../controllers/portfolioController'
      ...
      <div className="container">
        ...
        <div className="projects-grid">
          {projects.map((project, i) => (
            <div key={project.id} className="project-card" style={{ '--delay': `${i * 0.1}s` }}>
              ...
              <div className="project-body">
                ...
                <div className="project-tech">
                  {project.tech.map(t => (
                    <span key={t} className="tech-pill" style={{ '--c': project.color }}>{t}</span>
                  ))}
                </div>
              </div>
            </div>
